...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"jumbotron text-center\">\n    <h1>MEAN Authentication App</h1>\n    <p class=\"lead\">Welcome to our custom MEAN Authentication Application, built from scratch</p>\n    <div>\n        <a class=\"btn btn-primary\" style=\"margin-right: 5px\" [routerLink]=\"['/register']\">Register</a>\n        <a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n    </div>\n</div>\n\n<div class=\"row\">\n    <div class=\"col-md-4\">\n        <h3>Express Backend</h3>\n        <p>A rock solid Node.js/Express server using Mongoose to organize models and query the database</p>\n    </div>\n    <div class=\"col-md-4\">\n        <h3>Angular-CLI</h3>\n        <p>Angular-CLI generates components, services and more. Local dev sercer and easy compilation</p>\n    </div>\n    <div class=\"col-md-4\">\n        <h3>JWT Tokens</h3>\n        <p>Full featured authentication using JSON web tokens. Login and store user data</p>\n    </div>\n</div>";
    /***/
  },
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onRegisterSubmit() {
          ...
          this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
              _this3.flashMessage.show("You are registered abd can log in", {
                cssClass: 'alert-success',
                timeout: 3000
              });
              ...
              if (data.msg == "Existing User!") {
                _this3.flashMessage.show("It's a registered user, try with diffrent username", {
                  cssClass: 'alert-danger',
                  timeout: 3000
                });
              } else {
    ...
    function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function registerUser(user) {
          ...
          return this.http.post('users/register', user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        ...
        value: function authenticateUser(user) {
          ...
          return this.http.post('users/authenticate', user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
          }));
        }
      }, {
        ...
        value: function getProfile() {
          ...
          return this.http.get('users/profile', httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
          }));
        }
      }, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Projects\meanAuthApp\MeanAngularSrc\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
